            ...
            {lowStockItems > 0 ? (
              <div className="flex items-center justify-between p-3 bg-red-50 rounded-lg border border-red-100">
                <div>
                  ...
                  <p className="text-sm text-red-700">{lowStockItems} itens abaixo do estoque mínimo</p>
                </div>
            ...
            {pendingOrders > 0 ? (
              <div className="flex items-center justify-between p-3 bg-yellow-50 rounded-lg border border-yellow-100">
                <div>
                  ...
                  <p className="text-sm text-yellow-700">{pendingOrders} pedidos aguardando processamento</p>
                </div>
